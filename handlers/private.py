...
async def cmd_start(message: types.Message, bot: Bot):
    ...
    await message.answer(
        f"Привет, я {bot.get_my_name}. Создан чтобы помогать в администрировании чатов.\n"
        "Для начала работы введи в группе команду /admininit и следуй инструкциям."
        )
...
async def connect_group(message: types.Message):
    ...
    await message.answer(
        ...
        "Теперь вы можете управлять настройками бота через клавиатуру.",
